...
- **Watchlist** — remembers Grok-created paths (local only)  
- **Presence packs** — projects without XWare still count engine volume (aggregates only)  
- **Hub** — `~/.grok/xware_network/` shared across Godot / Unity / Unreal  
- **Global hints** — densify priorities rebuilt from all packs  
...
## True “every Grok project worldwide”
