...
1. **Engine** — if **new game** or **unknown**, **ask** Godot 4 / Unity URP / Unreal 5 (do not assume).
2. **Prefer spawn** `subagent_type="xware"` for multi-step work (own context).
...
```powershell
py tools/xware/ai/xai_textures.py --project . --set <missing_pbr_set>
py tools/xware/ai/apply_ai_textures.py --project . --all
```

## Laws

- Photoreal + physics for **ALL objects**
...
- **Ask engine** on new games and when engine is unknown
